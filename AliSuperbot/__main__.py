...
from AliSuperbot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          dispatcher, StartTime, telethn, updater, pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from AliSuperbot.modules import ALL_MODULES
from AliSuperbot.modules.helper_funcs.chat_status import is_user_admin
from AliSuperbot.modules.helper_funcs.misc import paginate_modules
...
ALI_IMG = "https://telegra.ph/file/a578f0c4bfab27127c188.jpg"
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Superbot Is Now Online!")
